                ...
                <div class="px-5 py-4 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <button onclick='openGroupModal(<?= json_encode($group) ?>)'
                                class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors" title="Edit Group">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <button onclick="deleteGroup('<?= htmlspecialchars($group['id']) ?>', '<?= htmlspecialchars(addslashes($group['name'])) ?>')"
                                class="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="Delete Group">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
